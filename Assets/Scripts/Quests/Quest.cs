...
public abstract class Quest : ScriptableObject
{
    ...
    // We might look into adding bools in GameManager like hasObtainItemQuest, hasEnterRegionQuest, etc to avoid calling this on
    // all active quests when it isn't necessary
