...
[System.Serializable]
public class HotSauceQuest : Quest
{
    [SerializeField]
    private Item sauceItem;
    [SerializeField]
    private int amountNeeded;
    private InventoryItem sauceInvItem;

    // Start is called before the first frame update
    private void Start()
    {
        sauceInvItem = new InventoryItem(sauceItem, amountNeeded); // the desired item of the quest
    }
    ...
    {
        return invItem.Equals(sauceInvItem);
    }
}